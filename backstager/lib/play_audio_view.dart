import 'dart:async';
import 'dart:io';
import 'package:backstager/models/audio_cut.dart';
...
class _PlayAudioViewState extends State<PlayAudioView> {
  ...
  final List<AudioCut> _cuts = [
    AudioCut(start: 0.0, end: 5.0),
    AudioCut(start: 5.0, end: 10.0),
    AudioCut(start: 10.0, end: 15.0),
  ];
